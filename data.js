...
const CONVERSIONS = [
  ...
  { team:'Team Remen', color:'#ECE9E4', reps:[
    ['Daniel Aliyu','57.58%',0.5758,{daily:{pg1:3,vip:3,clubs:0},weekly:{pg1:13,vip:14,clubs:2},monthly:{pg1:32,vip:29,clubs:5}}],
    ...
    ['Aileen Mendez','24.58%',0.2458,{daily:{pg1:2,vip:1,clubs:0},weekly:{pg1:8,vip:7,clubs:2},monthly:{pg1:21,vip:19,clubs:3}}],
