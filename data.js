...
const DATA_FILE_TIMESTAMP  = '2026-07-09T17:17:54Z';
...
const TEAM_PROFILES = {
  ...
  'Team Jen': {
    reps: 8, color: '#DB2C00',
    periods: {
      daily:   { act:{pg1:2,   vip:1,   clubs:1},   tgt:{pg1:32,  vip:32,  clubs:22}  },
  ...
  'Team Mark': {
    reps: 9, color: '#7B726C',
    periods: {
      daily:   { act:{pg1:1,   vip:1,   clubs:0},   tgt:{pg1:32,  vip:32,  clubs:22}  },
  ...
  'Team Remen': {
    reps: 9, color: '#ECE9E4',
    periods: {
      daily:   { act:{pg1:5,   vip:5,   clubs:6},    tgt:{pg1:36,  vip:36,  clubs:24}  },
