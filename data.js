...
const TEAM_PROFILES = {
  'Enterprise': {
    ...
    periods: {
      daily:   { act:{pg1:16,   vip:12,   clubs:11},   tgt:{pg1:150,  vip:150,  clubs:100}  },
      weekly:  { act:{pg1:89,   vip:48,   clubs:96},   tgt:{pg1:600,  vip:600,  clubs:400}  },
      monthly: { act:{pg1:1555, vip:1019, clubs:1257}, tgt:{pg1:2400, vip:2400, clubs:1600} },
    },
    conv: { sold:2306, calls:11951 },
    hasTrend: true,
    note: null,
  },
  'Team Anne': {
    ...
    periods: {
      ...
      weekly:  { act:{pg1:12,  vip:9,   clubs:22},   tgt:{pg1:206, vip:206, clubs:137} },
      monthly: { act:{pg1:436, vip:363, clubs:381},  tgt:{pg1:822, vip:822, clubs:548} },
    },
    hasTrend: true,
    note: null,
  },
  'Team Jen': {
    ...
    periods: {
      ...
      monthly: { act:{pg1:247, vip:198, clubs:273}, tgt:{pg1:506, vip:506, clubs:337} },
    },
    hasTrend: false,
    note: null,
  },
  ...
  'Team Mark': {
    ...
    periods: {
      ...
      monthly: { act:{pg1:255, vip:229, clubs:161}, tgt:{pg1:506, vip:506, clubs:337} },
    },
    hasTrend: false,
    note: null,
  },
  'Team Philip': {
    ...
    periods: {
      ...
      monthly: { act:{pg1:390, vip:8,  clubs:321},  tgt:{pg1:200, vip:200, clubs:200} },
    },
    hasTrend: false,
  ...
  'Team Remen': {
    ...
    periods: {
      ...
      monthly: { act:{pg1:195, vip:195, clubs:86},  tgt:{pg1:569, vip:569, clubs:379} },
    },
    hasTrend: false,
    note: null,
  },
...
const MONTHLY = {
  ...
  pg1:           [2938, 1842, 2615, 2069, 1707, 1555],
  vip:           [3055, 1859, 2338, 1966,  710, 1019],
  clubs:         [1399, 1539, 2120, 2037, 1187, 1257],
};

const WEEKLY = {
  labels: ['4/13','4/20','4/27','5/4','5/11','5/18','5/25','6/1','6/8','6/15','6/22'],
  pg1:    [459, 559, 327, 298, 401, 415, 556, 622, 463, 382, 89],
  vip:    [518, 420, 195,   0,   9, 296, 405, 428, 309, 234, 48],
  clubs:  [502, 406, 377, 280, 345, 241, 239, 367, 382, 412, 96],
};
...
const DAILY = {
  ...
  pg1:    [14,4,85,70,86,80,70,101,83,89,77,65,100,102,116,103,91,29,15,139,124,137,110,82,157,97,51,81,70,19,15,86,67,81,61,22,73,16],
  vip:    [0,0,0,0,0,8,1,58,73,73,55,37,84,80,75,76,65,17,8,102,86,92,76,60,119,68,26,55,32,11,7,58,42,48,36,12,36,12],
  clubs:  [14,13,61,73,68,62,63,45,57,54,42,43,36,43,51,40,48,12,9,62,61,72,61,64,63,69,63,81,74,20,16,73,68,77,77,32,85,11],
};

// Team Anne full trend (monthly Feb–present, weekly 4/13–present)
const ANNE_MONTHLY = {
  labels: ['Feb','Mar','Apr','May','Jun MTD'],
  pg1:    [546,  1113, 944, 609, 436],
  vip:    [408,   910, 721, 289, 363],
  clubs:  [240,   305, 287, 353, 381],
};
...
const PHONE_SETTERS_MONTHLY = {
  labels:   ['Feb','Mar','Apr','May','Jun MTD'],
  sets:     [689,  1078, 469, 506, 368],
  show:     [336,  457,  288, 304, 202],
  closed:   [130,  122,  99,  93,  78],
  cash_rev: [null, null, null, null, 448874],
...
const PHONE_SETTERS_DAILY = {
  ...
  sets:     [33, 33, 14,  4,  2, 21, 35, 22, 20, 24,  1,  2, 24, 29, 13, 23,  0, 40,  0],
  show:     [ 6,  9,  9,  9,  0, 14, 11, 12, 12, 21,  8,  0, 16,  7, 12, 10,  1, 14,  2],
  closed:   [ 1,  3,  5,  5,  0,  4,  7,  3,  5,  7,  7,  0,  5,  1,  4,  6,  0,  6,  0],
  cash_rev: [3000,12833,36830,24000,0,29600,32200,17300,24450,37095,39100,0,30250,6500,7500,0,0,0,0],
  cash_ref: [0,   0,   0,   0,   0,-4100,-2000,0,    0,    0,    0,   0,0,    -2000,0,  0, 0, 0, 0],
};
...
const PHONE_SETTERS_REPS = [
  ...
  ['Phoebe Estel Ymil Collado', {daily:{sets:0,show:0,cash_rev:0,cash_ref:0}, weekly:{sets:0,show:1,cash_rev:0,cash_ref:0}, monthly:{sets:4, show:20,cash_rev:52616,cash_ref:-5100}}],
  ...
  ['Richard Ian Alvarez',       {daily:{sets:0,show:1,cash_rev:0,cash_ref:0}, weekly:{sets:0,show:3,cash_rev:0,cash_ref:0}, monthly:{sets:0, show:25,cash_rev:63666,cash_ref:-2000}}],
