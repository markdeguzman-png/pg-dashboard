...
const DATA_FILE_TIMESTAMP  = '2026-07-08T14:07:27Z';
...
const TEAM_PROFILES = {
  'Enterprise': {
    ...
    periods: {
      daily:   { act:{pg1:4,    vip:4,    clubs:3},    tgt:{pg1:150,  vip:150,  clubs:100}  },
  ...
  'Team Anne': {
    ...
    periods: {
      daily:   { act:{pg1:2,   vip:2,   clubs:0},    tgt:{pg1:52,  vip:52,  clubs:35}  },
...
const DAILY = {
  ...
  pg1:    [14,4,85,70,86,80,70,101,83,89,77,65,100,102,116,103,91,29,15,139,124,137,110,82,157,97,51,81,70,19,15,86,67,81,60,70,71,69,71,50,45,62,54,48,57,4],
  vip:    [0,0,0,0,0,8,1,58,73,73,55,37,84,80,75,76,65,17,8,102,86,92,76,60,119,68,26,55,32,11,7,58,42,48,36,41,35,41,38,26,27,44,37,43,48,4],
  clubs:  [14,13,61,73,68,62,63,45,57,54,42,43,36,43,51,40,48,12,9,62,61,72,61,64,63,69,63,81,74,20,15,74,68,77,75,72,85,69,85,75,77,79,44,61,49,3],
};
