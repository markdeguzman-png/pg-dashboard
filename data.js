...
const DATA_FILE_TIMESTAMP  = '2026-07-02T22:04:31Z';
...
const TEAM_PROFILES = {
  'Enterprise': {
    ...
    periods: {
      daily:   { act:{pg1:57,   vip:48,   clubs:49},   tgt:{pg1:150,  vip:150,  clubs:100}  },
  ...
  'Team Anne': {
    ...
    periods: {
      daily:   { act:{pg1:21,  vip:16,  clubs:21},   tgt:{pg1:52,  vip:52,  clubs:35}  },
...
const DAILY = {
  ...
  vip:    [0,0,0,0,0,8,1,58,73,73,55,37,84,80,75,76,65,17,8,102,86,92,76,60,119,68,26,55,32,11,7,58,42,48,36,41,35,41,38,26,27,44,37,43,48],
  clubs:  [14,13,61,73,68,62,63,45,57,54,42,43,36,43,51,40,48,12,9,62,61,72,61,64,63,69,63,81,74,20,15,74,68,77,75,72,85,69,85,75,77,79,44,61,49],
};
