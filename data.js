...
const DATA_FILE_TIMESTAMP  = '2026-07-02T19:33:17Z';
...
const TEAM_PROFILES = {
  'Enterprise': {
    ...
    periods: {
      daily:   { act:{pg1:30,   vip:30,   clubs:36},   tgt:{pg1:150,  vip:150,  clubs:100}  },
  ...
  'Team Mark': {
    reps: 9, color: '#7B726C',
    periods: {
      daily:   { act:{pg1:3,   vip:4,   clubs:0},   tgt:{pg1:32,  vip:32,  clubs:22}  },
